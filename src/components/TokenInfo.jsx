    ...
    <div className="flex flex-col space-y-5 lg:space-y-0 lg:flex-row items-center justify-center lg:space-x-10 font-little" id='col'>
          <div className="bg-white text-black rounded-[30px] p-5" data-aos="fade-right" data-aos-duration="1500">
            ...
            <ul className="flex flex-col space-y-4">
              <li className="bg-[#be22f7] justify-between space-x-10 items-center p-2 rounded-[20px] border-2 px-5 border-black flex">
                <p className="font-bold text-[36px] text-white">Token Name</p>
                <p className="text-[24px] text-white">$NEIROH</p>
              </li>
          
              <li className="bg-[#be22f7] text-white justify-between items-center p-2 rounded-[20px] border-2 px-5 border-black flex">
          ...
          <div className="bg-white text-black rounded-[30px] p-5" data-aos="fade-left" data-aos-duration="1500">
            ...
            <ul className="flex flex-col space-y-4">
              <li className="bg-[#be22f7] text-white flex-col lg:flex-row justify-between space-x-2 items-center p-2 rounded-[20px] border-2 px-5 border-black flex">
                <p className="font-bold text-[36px]">CA </p>
                <p className="text-[9px] lg:text-[14px]">BJ2ENyjuBGUQJr6CCDBcGAQNQDbayoNbDziDGrWSQQ4</p>
              </li>
              <li className="bg-[#be22f7] text-white justify-between items-center p-2 rounded-[20px] border-2 px-5 border-black flex">
